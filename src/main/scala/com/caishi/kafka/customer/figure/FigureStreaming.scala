...
object FigureStreaming {
  def main(args: Array[String]): Unit = {
    if (args.length < 9) {
      System.err.println("Usage: Common <brokers> <topics> <timeWindow> <numRepartition> <pathPre:hdfs pre >")
      System.exit(1)
    }
...
//    val mongoRemotes="10.4.1.25:27017,10.4.1.6:27017,10.4.1.23:27017"
